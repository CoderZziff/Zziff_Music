...
//   {
//     path: '/playlist/:id',
//     component: () => import(/* webpackChunkName: "playlist-id" */ '@/views/Playlist/_id.vue'),
//     name: 'playlist-id',
...
//         component: () => import(/* webpackChunkName: "playlist-id-comment" */ '@/views/Playlist/_id/comment.vue'),
//         name: 'playlist-id-comment'
//       },
//       {
//         path: '/playlist/:id/subscriber',
//         component: () => import(/* webpackChunkName: "playlist-id-subscriber" */ '@/views/Playlist/_id/subscriber.vue'),
